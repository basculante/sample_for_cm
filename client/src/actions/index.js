...
export const fetchMyCompletedSurveys = surveyId => async dispatch => {
	const res = await axios.post("/api/myCompletedSurveys");

	dispatch({ type: FETCH_MY_COMPLETED_SURVEYS, payload: res.data });
};
